...
# Create a ball surface with marker to show rotation
...
while running:
    ...
    # Draw shapes avoided (upper right)
    ...
    # Check for collision with the the bottom wall
        ...
        if current_shape == SHAPE_RECT:
            ...
            def draw_star(surf, color, alpha):
                ...
                for i in range(5):
                    ...
                    y = cy + int(18 * pygame.math.Vector2(1, 0).rotate(angle).y)
                    points.append((x, y))
                pygame.draw.polygon(surf, (*rect_color, rect_alpha), points)
